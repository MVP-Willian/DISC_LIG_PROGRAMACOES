...
class LLMAgent(BaseAgent):
    ...
    def __init__(self, name: str, llm_url: str):
        ...
        # Carta escolhida na rodada atual (setada em choose_card e usada em
        # send_clue para conhecer o título e evitar vazá-lo na dica).
    ...
    # =========================================================================
    # NARRADOR — tool 1: escolha da carta
    # =========================================================================
    @tool()
    ...
    # =========================================================================
    # NARRADOR — tool 2: geração da dica (decisão semântica -> LLM)
    # =========================================================================
    @tool()
    ...
    # =========================================================================
    # MELÔMANO — mantido conforme a referência (NÃO é o foco deste trabalho).
    # Incluído apenas para o arquivo ser completo e executável. Se você já tem
    # um melômano testado e melhor, use o seu: a interface é a mesma.
    # =========================================================================
    @tool()
    async def select_card_by_clue(self, clue: str) -> Dict[str, Any]:
        ...
        chosen_idx = random.randrange(len(self.hand)) if best_score <= 0 else best_indices[0]
    ...
    # =========================================================================
    # Helper do MELÔMANO (igual à referência)
    # =========================================================================
